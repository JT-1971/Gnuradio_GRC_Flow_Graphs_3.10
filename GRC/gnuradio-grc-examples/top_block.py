...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0.set_center_freq(434500000, 0)
        ...
        self.hilbert_fc_0 = filter.hilbert_fc(256, window.WIN_HAMMING, 6.76)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vcc(1)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(1)
        self.audio_source_0 = audio.source(48000, 'default', True)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 50e3, 100, 0, 0)
        ...
        self.connect((self.hilbert_fc_0, 0), (self.blocks_multiply_xx_0_0, 1))
