...
class cm_options(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "cm_options")
        ...
        # Variables
        ##################################################
        self.center_freq = center_freq = 435.1e6
        ...
        self._channel_freq_range = qtgui.Range(80e6, 500e6, 5e3, center_freq, 200)
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.center_freq, 20e6)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 25e3, 5e3, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=cm_options, options=None):
